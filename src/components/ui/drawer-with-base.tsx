...
export {
  ...
  DrawerClose as DrawerBaseClose,
  DrawerContent as DrawerBaseContent,
  DrawerDescription as DrawerBaseDescription,
  DrawerFooter as DrawerBaseFooter,
  DrawerHeader as DrawerBaseHeader,
  DrawerOverlay as DrawerBaseOverlay,
  DrawerPortal as DrawerBasePortal,
  DrawerTitle as DrawerBaseTitle,
  DrawerTrigger as DrawerBaseTrigger,
};
